...
export const Menu: React.FC<MenuProps> = ({ onClose }) => {
  const menuItems = [
    ...
    { title: 'Services', link: '#' },
    { title: 'About Studio', link: '#' },
    { title: 'Dverso Editor', link: '#' },
    { title: 'Contact', link: '#' },
  ];
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#0047FF] flex flex-col p-8 md:p-16">
      <div className="flex justify-between items-center mb-20">
        <h1 className="pixel-font text-3xl">Dverso</h1>
      ...
      <div className="mt-auto flex flex-col md:flex-row justify-between pt-12 border-t border-white border-opacity-20 gap-8">
        <div className="flex flex-col gap-4">
          <span className="text-[10px] opacity-60 uppercase tracking-widest font-bold">Social</span>
        ...
        <div className="flex flex-col gap-4 md:text-right">
          <span className="text-[10px] opacity-60 uppercase tracking-widest font-bold">Contact</span>
          <a href="mailto:hello@dverso.io" className="text-xl md:text-2xl font-bold lowercase">hello@dverso.io</a>
        </div>
      </div>
    </div>
  );
